...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    if (userId != "") {
      ...
      Quantity qty = Quantity.of(s.nextInt());

      booking(id, qty.value, userId);

      System.out.println("Number of VHS : " + qty + " , final price: 8€ x " + qty + " VHS = " + qty.multiply(8) +
              ", If you buy one more : 7€ x " + qty.add(Quantity.of(1)) + " VHS = " + (qty.add(Quantity.of(1))).multiply(7) + " €");
    } else {
